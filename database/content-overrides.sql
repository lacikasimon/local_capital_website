...
-- Ensure translated core pages exist even when an earlier import missed them.
...
('en', 'home', '/', 'Fast and simple credit for financial independence', 'Local Capital offers flexible credit solutions for personal needs, with a clear process and a fast answer.', '## Your plan becomes reality with Local Capital

Do you have clear financial goals and need quick support? Local Capital helps you access solutions for education, home, health, family, or consolidating existing debts.

Our process is designed to be simple: we discuss the need, check eligibility, and present a transparent repayment option.', 'Apply now', '/contact', 'View loans', '/contract', '{}'),
('en', 'about', '/about-us', 'About Local Capital', 'We are a Romanian non-bank financial institution focused on fast and flexible credit for individuals.', '## Our company

Local Capital is a Romanian non-bank financial institution focused on fast and flexible credit for individuals.

We want to make the path toward financial solutions easier. Our team helps you understand the available options.', NULL, NULL, NULL, NULL, '{}'),
('en', 'contract', '/loan-types', 'Loan types offered', 'Credit products created for different financial goals, with clear repayment options.', '## Financing packages

Local Capital presents credit products created for different requirements and preferences. The final offer is discussed before signing.', NULL, NULL, NULL, NULL, '{}'),
('en', 'contact', '/contact', 'Contact us', 'Write or call us for information about credit and financing solutions.', '## Feel free to contact us

For questions about eligibility, credit products, or next steps, use the contact details below.', NULL, NULL, NULL, NULL, '{}'),
('hu', 'home', '/', 'Gyors és egyszerű hitel a pénzügyi önállósághoz', 'A Local Capital rugalmas hitelmegoldásokat kínál személyes igényekre, átlátható folyamattal és gyors válasszal.', '## Terveid valóra válhatnak a Local Capitallal

Világos pénzügyi céljaid vannak, és gyors támogatásra van szükséged? A Local Capital segít elérni a megfelelő megoldást.

A folyamatunk egyszerű: megbeszéljük az igényt, ellenőrizzük a jogosultságot, és átlátható törlesztési lehetőséget mutatunk be.', 'Igénylés', '/contact', 'Hitelek megtekintése', '/contract', '{}'),
('hu', 'about', '/rolunk', 'A Local Capitalról', 'Romániai nem banki pénzügyi intézmény vagyunk, gyors és rugalmas személyi hitelekre szakosodva.', '## Cégünk

A Local Capital romániai nem banki pénzügyi intézmény, amely személyi hitelmegoldásokra szakosodott.

Csapatunk segít megérteni a rendelkezésre álló lehetőségeket és a fontos feltételeket.', NULL, NULL, NULL, NULL, '{}'),
('hu', 'contract', '/hitelek', 'Elérhető hiteltípusok', 'Különböző pénzügyi célokra kialakított hiteltermékek, világos törlesztési lehetőségekkel.', '## Finanszírozási csomagok

A Local Capital különböző igényekre és preferenciákra kialakított hiteltermékeket kínál. A végleges ajánlatot aláírás előtt beszéljük át.', NULL, NULL, NULL, NULL, '{}'),
('hu', 'contact', '/kapcsolat', 'Kapcsolatfelvétel', 'Írj vagy hívj minket gyors hitelekkel és finanszírozási megoldásokkal kapcsolatban.', '## Fordulj hozzánk bizalommal

Jogosultsággal, hiteltermékekkel vagy a következő lépésekkel kapcsolatos kérdések esetén használd az alábbi elérhetőségeket.', NULL, NULL, NULL, NULL, '{}')
